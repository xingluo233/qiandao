...
export default async function main() {
    ...
    let response = await got.post(`https://sslyapp.site/mz_pbl/app_con/add_sign.php`, {
        body: data,
        headers: {
            "Content-Type": "application/x-www-form-urlencoded",
            "user-agent": "Mozilla/5.0 (Linux; Android 12; PESM10 Build/RKQ1.211119.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.196 Mobile Safari/537.36 Html5Plus/1.0"
        }
    });
